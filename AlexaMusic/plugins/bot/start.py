...
async def alive(client, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 exelans sohbet 💮", url=f"https://t.me/diyarbakirsohbet2121")]]
        ),
    )
...
async def verify(client, message: Message):
    ...
    await message.reply_photo(
        photo=f"https://te.legra.ph/Exelans-04-04-2",
        caption=f"""━━━━━━━━━━━━━━━━━━━━━━━━\n\n✪ **ᴄᴏɴɢʀᴀᴛᴜʟᴀᴛɪᴏɴ** 🎉\n✪ ɴᴏᴡ ʏᴏᴜ ᴀʀᴇ exelans ᴠᴇʀɪғɪᴇᴅ ᴍᴇᴍʙᴇʀ ɢᴏ ʙᴀᴄᴋ ᴀɴᴅ ᴇɴᴊᴏʏ ᴏᴜʀ sᴇʀᴠɪᴄᴇ ᴀɴᴅ ᴘʟᴀʏ ᴍᴜsɪᴄ 🌼 ..\n\n━━━━━━━━━━━━━━━━━━━━━━━━""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 exelans sohbet 💮", url=f"https://t.me/diyarbakirsohbet2121")]]
        ),
    )
